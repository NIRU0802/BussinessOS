 ...
 * the token only ever originates from our own trusted API responses
 * (login/refresh). Signature verification is always enforced server-side.
 * Identical to apps/admin/src/lib/jwt.ts.
 */
